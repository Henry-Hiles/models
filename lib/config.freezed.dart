...
class _$ConfigCopyWithImpl<$Res, $Val extends Config>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      pkgs: null == pkgs
          ? _value.pkgs
          : pkgs // ignore: cast_nullable_to_non_nullable
              as List<Package>,
    ) as $Val);
  }
}
...
class _$ConfigImpl extends _Config {
  ...
  List<Package> get pkgs {
    if (_pkgs is EqualUnmodifiableListView) return _pkgs;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_pkgs);
  }
